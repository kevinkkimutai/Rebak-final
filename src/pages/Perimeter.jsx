...
import chain from "../assets/perimeter/perimeterfenc.jpg"
...
function Perimeter() {
  return (
      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <a href="/perimeter" className="ms-1 text-md font-semibold text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Perimeter</a>
          </div>
        </li>
    ...
    <section
        id="home"
        className="perimeter relative z-10 overflow-hidden pt-[120px] pb-1 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
      >
    ...
    <div className="containe text-center ms-0 ">
      ...
      Discover the durability and security of our Perimeter fencing solutions, offering reliable protection for your property.
      </p>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 object-cover" >
    ...
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={chain} alt="" />
    </div>
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={chain} alt="" />
    </div>
