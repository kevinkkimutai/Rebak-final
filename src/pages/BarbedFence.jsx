...
import chain from "../assets/barbed/barbed1.jpg"
import chain2 from "../assets/barbed/barbed2.jpg";
import chain3 from "../assets/barbed/barbed3.jpg";
import chain4 from "../assets/barbed/barbed4.jpg";
import chain5 from "../assets/barbed/barbed66.png";
import chain6 from "../assets/barbed/barbedwire (1).jpg"

function BarbedFence() {
  return (
    <div className="mt-16">
    ...
    <section
        id="home"
        className=" barbed relative z-10 overflow-hidden pt-[120px] pb-1 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
      >
    ...
    <div className="containe text-center ms-0 ">
      ...
      Discover the durability and security of our Barbed Wire fencing solutions, offering reliable protection for your property.
      </p>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 object-cover" >
    ...
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={chain4} alt="" />
    </div>
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={chain6} alt="" />
    </div>
</div>
