...
import chain from "../assets/chainlink/cahinz1.jpg"
import chain2 from "../assets/chainlink/chainz.jpg";
import chain3 from "../assets/chainlink/one1.jpg";
import chain4 from "../assets/chainlink/sample chainlink 3.jpg";
import chain5 from "../assets/chainlink/sample chainlink.jpg"

function ChainLinkService() {
  return (
    <div className="mt-16">
      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <a href="/chainlink" className="ms-1 text-md font-semibold text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Chainlink</a>
          </div>
        </li>
    ...
    <section
        id="home"
        className=" chain relative z-10 overflow-hidden pt-[120px] pb-1 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
      >
    ...
    <div className="containe text-center ms-0 ">
      ...
      <p className="mb-8 font-serif  font-medium  text-body-color  text-gray-500 dark:opacity-90 text-xl md:text-3xl">
      Discover the durability and security of our chain-link fencing solutions, offering reliable protection for your property.
      </p>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4" >
    <div>
        <img className="h-auto max-w-full rounded-lg" src={chain} alt="" />
    </div>
    <div>
        <img className="h-auto max-w-full rounded-lg" src={chain5} alt="" />
    </div>
    <div>
