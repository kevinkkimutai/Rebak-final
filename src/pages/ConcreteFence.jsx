...
import concrete1 from '../assets/concrete/concrete1.jpeg'
import concrete2  from '../assets/concrete/concrete2.jpeg'
import concrete3 from '../assets/concrete/concrete3.jpeg'
import concrete4 from '../assets/concrete/concrete4 (1).jpeg'
...
const ConcreteFence = () => {
  return (
      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <a href="/concrete" className="ms-1 text-md font-semibold text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Concrete</a>
          </div>
        </li>
    ...
    <section
        id="home"
        className="concrete relative z-10 overflow-hidden pt-[120px] pb-1 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
      >
    ...
    <div className="containe text-center ms-0 ">
     ...
     Concrete Fencing Solutions
      </h1>
      <p className="mb-8 font-serif  font-medium  text-body-color  text-gray-500 dark:opacity-90 text-xl md:text-2xl">
      Discover the durability and security of our Concrete fencing solutions, offering reliable protection for your property.
      </p>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 object-cover" >
    ...
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={concrete1} alt="" />
    </div>
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={concrete2} alt="" />
    </div>
  
    <div>
        <img className="max-h-56 w-full h-full  max-w-full rounded-lg" src={concrete3} alt="" />
    </div>
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={concrete1} alt="" />
    </div>
    <div>
        <img className="max-h-56 w-full h-full max-w-full rounded-lg" src={concrete4} alt="" />
    </div>
